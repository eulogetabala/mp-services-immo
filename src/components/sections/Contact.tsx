          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-6 group">
                ...
                <div>
                  <span className="text-xs uppercase tracking-widest text-charcoal block mb-1 font-medium">Localisation</span>
                  <span className="text-lg font-black text-navy">{CONTACT_INFO.address}</span>
                </div>
              </div>
            </div>
          </motion.div>
